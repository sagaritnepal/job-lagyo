    ...
    <div>
      ...
      <div className="mt-3.5 grid gap-3 sm:grid-cols-2">
        <Link
          ...
          className="rounded-lg border border-neutral-200 bg-white p-3.5 hover:border-primary-300 hover:shadow-sm"
        >
          <p className="flex items-center gap-2 text-sm font-semibold text-neutral-900">
            <ShieldCheck className="h-4 w-4 text-primary-600" /> Review pending jobs
          </p>
        ...
        >
          <p className="flex items-center gap-2 text-sm font-semibold text-neutral-900">
            <Building2 className="h-4 w-4 text-primary-600" /> Manage vendors
          </p>
          <p className="mt-1 text-xs text-neutral-500">
